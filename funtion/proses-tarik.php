...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kaskel (nama, hp, tujuan, penerima, jumlah, bidang, ket) VALUES ('$namaLengkap', '$noHp', '$sumberDana', '$penerima', '$jumlah', '$bidang', '$status')";

    if ($conn->query($sql) === TRUE) {
        $message = "Tarik dana berhasil diajukan. Menunggu persetujuan dari bendahara. silakan hubungi bendahara, no.hp 085242436146";
    } else {
        $message = "Terjadi kesalahan. Silakan coba lagi.";
    }

    $sql2 = "INSERT INTO rekap (nama, keterangan, jenis, ket, masuk, keluar) VALUES ('$namaLengkap', '$sumberDana', '$jenis', '$status', '0', '$jumlah')";
